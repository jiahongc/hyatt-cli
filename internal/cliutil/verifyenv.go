...
// VerifyEnvVar is the env var the local verifier sets in every
...
const VerifyEnvVar = "HYATT_CLI_VERIFY"
...
const VerifyLiveHTTPEnvVar = "HYATT_CLI_VERIFY_LIVE_HTTP"

// DogfoodEnvVar is the env var the live verification runner
...
const DogfoodEnvVar = "HYATT_CLI_DOGFOOD"

// IsVerifyEnv reports whether the current process is running under the
// local verifier in mock mode. Commands with side
...
// the live verification matrix. Long-running commands (full
